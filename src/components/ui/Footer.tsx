...
export default function Footer() {
  ...
  return (
    <footer className="py-10" style={{ borderTop: "1px solid var(--border)", background: "var(--bg)" }}>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          >
            <span
              ...
              style={{ color: "var(--text-subtle)", letterSpacing: "0.16em" }}
            >
              &copy; {new Date().getFullYear()} &middot; {personalInfo.name}
            </span>
          </motion.div>
          ...
          <motion.button
            ...
            className="flex items-center gap-1.5 text-xs font-mono uppercase transition-opacity hover:opacity-60"
